...
<body
    style="direction:rtl; font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #f5f8fa; color: #74787E; height: 100%; hyphens: auto; line-height: 1.4; margin: 0; -moz-hyphens: auto; -ms-word-break: break-all; width: 100% !important; -webkit-hyphens: auto; -webkit-text-size-adjust: none; word-break: break-word;">
    <style>
        .td-style {
                    ...
                    <tr>
                        <td class="body" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <!-- Body content -->
                                <tr>
                                    <td class="content-cell td-style">
                                        <h2>اطلاعات مشتری</h2>
                                        <p>نام مشتری: {{ $order->user->first_name }} {{ $order->user->last_name }}</p>
                                        <p>نام کاربری مشتری: {{ $order->user->username }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-cell td-style">
